      ...
      <div className="rounded-lg border p-4 shadow-xs border-emerald-700 bg-gray-800 md:p-6">
        <div className="flex flex-col md:flex-row md:items-center md:gap-6">
          <div className="shrink-0 mb-4 md:mb-0">
            <img
              className="h-24 w-24 md:h-32 md:w-32 rounded-sm object-cover"
              src={item.image}
              alt={item.title}
            />
          </div>
          <div className="flex-1 min-w-0 space-y-2">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="bg-emerald-700 text-white text-xs font-semibold px-2 py-0.5 rounded-full ml-2">
                Bundle
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-2 items-center mb-2">
              {item.products?.slice(0, 4).map((p) => (
                <div
                  key={p._id}
                  className="flex items-center gap-1 bg-gray-900 rounded-sm px-2 py-1 text-xs"
                >
                  {p.image && (
                    <img
                      src={p.image}
                  ...
                  <span className="text-gray-200 max-w-16 truncate">
                    {p.name}
                  </span>
                </div>
              ))}
