...
function BundlesPreview() {
  ...
  return (
      ...
      <section className=" my-16 ">
        <h2 className="text-5xl font-bold text-black mb-2 text-left">
          Bundles
        </h2>
        <p className="text-left text-black mb-8 max-w-2xl ">
          Curated plant bundles for every home. Save more with our exclusive
          offers!
        </p>
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {(showAll ? bundles : bundles.slice(0, visibleCount)).map(
            (bundle) => (
