...
function CollectionsPreview() {
  ...
  return (
    <section className="my-16">
      ...
      <div className="grid grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
        {(showAll ? collections : collections.slice(0, visibleCount)).map(collection => (
          ...
          >
            <div className="relative bg-gray-900 overflow-hidden rounded-t-lg flex items-center justify-center w-full aspect-square basis-1/2 md:basis-auto">
              <img src={collection.image} alt={collection.title} className="w-full h-full object-cover rounded-t-lg" />
            ...
            <div className="flex-1 flex flex-col p-5">
              ...
              <div className="hidden md:block text-gray-200 mb-2 line-clamp-2 flex-1 max-h-[3.2em] overflow-hidden">{collection.description}</div>
              ...
              <div className="flex gap-2 mt-6">
                ...
                <button
                  ...
                  tabIndex={0}
                >
                  <Zap className="w-5 h-5 md:hidden" /><span className="hidden md:inline">Buy Now</span>
                </button>
              </div>
            </div>
          </div>
