...
const Navbar = () => {
  ...
  return (
    <>
      {showOverlay && <div className="fixed inset-0 bg-black/60 z-40" onClick={() => setShowOverlay(false)} />}
      <header
          ...
          <div className="flex w-full items-center gap-2 md:gap-4">
            ...
            <div className="flex-1 flex justify-center md:justify-center items-center relative z-50">
              ...
              <div className="w-full max-w-md relative">
                <div
                  className={`flex items-center ${location.pathname === '/' ? ' bg-primary' : 'bg-secondary'} rounded-lg px-2 py-1 md:px-3 md:py-2
...
${location.pathname === '/' ? 'text-white placeholder-white/70' : 'text-black placeholder-gray-500'}
...
`}
                        ...
                        >
                          ...
                          <span className="text-gray-900 font-medium line-clamp-1">{s.name}</span>
