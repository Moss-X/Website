            ...
            >
              ...
              <div className="flex-1 flex flex-col gap-1 p-5">
                ...
                <div className="flex items-center gap-4 mb-4">
                  <span className="text-md md:text-xl  text-black font-semibold  line-clamp-1">₹{bundle.discountedPrice}</span>
                ...
                <div className="flex flex-wrap gap-2 mt-auto pt-2 border-t border-darkGray ">
                  {bundle.products.slice(0, 2).map(p => (
                    <Link
                      ...
                      tabIndex={0}
                    >
                      {p.image && <img src={p.image} alt={p.name} className="w-6 h-6 object-cover rounded-sm group-hover:ring-2 group-hover:ring-primary transition" />}
