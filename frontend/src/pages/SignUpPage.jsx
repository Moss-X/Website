						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-xs'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-gray-700 border border-gray-600 rounded-md shadow-xs
									 placeholder-gray-400 focus:outline-hidden focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm'
							...
							<div className='mt-1 relative rounded-md shadow-xs'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-gray-700 border
									 border-gray-600 rounded-md shadow-xs placeholder-gray-400 focus:outline-hidden focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>
