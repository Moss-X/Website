...
function BundlePage() {
  ...
  if (error || !bundle)
    return (
      <div className="min-h-screen flex items-center justify-center text-red-400">{error || 'Bundle not found'}</div>
    )
      ...
      <section className="relative w-full max-w-(--breakpoint-xl) mx-auto flex flex-col md:flex-row items-center md:items-start gap-8 px-4 sm:px-6 lg:px-8 pt-12 pb-8">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start">
          ...
          <div className="flex gap-4 py-4 px-4 md:p-0 justify-center md:justify-start w-full max-w-(--breakpoint-xl) mx-auto">
            ...
            <button className="px-6 py-3 flex bg-secondary text-black rounded-full shadow-md hover:bg-gray-200 transition whitespace-nowrap font-semibold text-lg">
              Buy Bundle
            </button>
          </div>
        </div>
